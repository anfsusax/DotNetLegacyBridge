...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container mt-3">
        <div class="card shadow p-4">
            <h4 class="mb-3 text-primary">Cadastro de Cliente</h4>
            ...
            <hr />
            <h5 class="mb-2 text-secondary">Endereço</h5>
        ...
        <div class="mt-4">
            <asp:GridView ID="gdvClientes" runat="server" CssClass="table table-striped table-bordered" AutoGenerateColumns="False" OnRowCommand="gdvClientes_RowCommand1">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Ações">
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkEditar" CommandName="Editar" CommandArgument='<%# Eval("Id") %>' runat="server" CssClass="btn btn-sm btn-warning me-1">Editar</asp:LinkButton>
                            <asp:LinkButton ID="lnkExcluir" CommandName="Excluir" CommandArgument='<%# Eval("Id") %>' runat="server" CssClass="btn btn-sm btn-danger" OnClientClick="return confirm('Excluir cliente?');">Excluir</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
